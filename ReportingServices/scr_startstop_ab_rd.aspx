<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="scr_startstop_ab_rd.aspx.cs" Inherits="ReportingServices.scr_startstop_ab_rd" MasterPageFile="~/Site1.Master" %>
...
<asp:Content ID="content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="1209px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1270px" ProcessingMode="Remote">
            <ServerReport ReportPath="/scr_startstop_ab_rd"/>
        </rsweb:ReportViewer>
    </div>
